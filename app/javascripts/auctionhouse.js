...
function updateEthNetworkInfo() {
    ...
    if (typeof auctionHouseContract != 'undefined' && typeof account != 'undefined') {
        ...
        auctionHouseContract.getRefundValue({ from: account }, function(err, refundBalance) {
    ...
    var provider = web3.version.getNetwork(function(err, net) {
        ...
        if (net == 11) {
            networkDisplay = "Private Parity Network";
        } else {
            networkDisplay = net;
        }
...
function withdraw() {
    if (typeof auctionHouseContract != 'undefined' && typeof account != 'undefined') {
        ...
        auctionHouseContract.withdrawRefund({ from: account, gas: 500000 }, function(err, txId) {
