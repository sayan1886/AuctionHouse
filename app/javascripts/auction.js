...
function refreshAuction() {
    ...
    auctionHouseContract.getAuctionCount({ from: account }, function(err, auctionCount) {
    ...
    auctionHouseContract.getStatus(auctionId, { from: account }, function(err, auctionStatus) {
        ...
        auctionHouseContract.getAuction(auctionId, { from: account }, function(err, result) {
...
function activateAuction() {
    ...
    assetContract.owner(auction["recordId"], { from: account }, function(err, ownerAddress) {
        if (ownerAddress != auctionHouseContract.address) {
            // Asset not owned by contract. First set its owner to this contract
            assetContract.setOwner(auction["recordId"], auctionHouseContract.address, { from: account, gas: 500000 }, function(err, txnId) {
...
function performActivation() {
    ...
    showSpinner();
    auctionHouseContract.activateAuction(auction["auctionId"], { from: account, gas: 500000 }, function(err, txnId) {
...
function placeBid() {
    ...
    var gas = 1400000;
    auctionHouseContract.placeBid(auction["auctionId"], { from: account, value: bid, gas: gas }, function(err, txnId) {
...
function endAuction() {
    ...
    showSpinner();
    auctionHouseContract.endAuction(auction["auctionId"], { from: account, gas: 1400000 }, function(err, txnId) {
